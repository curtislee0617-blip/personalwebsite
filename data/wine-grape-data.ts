...
export const wineGrapes: WineGrape[] = [
  ...
  grape("loureiro", "Loureiro", "white", [], "Minho, Portugal", "Late-ripening and well adapted to cool, rainy Atlantic valleys.", "Bay leaf, orange blossom, lime and green apple.", "High acid and light to medium body.", ["Vinho Verde", "Lima Valley"], "Old north-west Iberian variety whose name refers to laurel-like aroma.", ["still"]),
  ...
  grape("graciano", "Graciano", "red", [], "Northern Spain", "Late-ripening, low-yielding and sensitive to drought.", "Blackberry, violet and spice.", "High acid and tannin with deep colour.", ["Rioja", "Navarra"], "Old Iberian variety; genetically the same as Sardinia’s Bovale Sardo.", ["still"]),
  ...
  grape("tannat", "Tannat", "red", ["Harriague"], "South-west France", "Late-ripening and thick-skinned; thrives in warm sunny regions.", "Blackberry, plum, liquorice and smoke.", "Very high tannin, high acid and deep colour.", ["Madiran", "Uruguay", "Argentina"], "Old Pyrenean variety with numerous offspring in south-west France.", ["still"]),

...
const nameRules = [
  ...
  ["East Asian", /\b(chinese|china|hong kong|cantonese|sichuan|szechuan|chengdu|taiwanese|taiwan|japanese|japan|izakaya|tempura|udon|soba|yakiniku|korean|korea|bibimbap|dim sum|xiaolongbao)\b/i],

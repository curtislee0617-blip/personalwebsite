          ...
          {result ? (
            <>
              ...
              <section className="compound-formation-results" aria-label="Enthalpy and Gibbs energy of formation at 298 kelvin and 1 bar">
                ...
                <article><p>ΔH°<sub>f,298</sub><span>enthalpy of formation</span></p><strong>{calculatedCompound.formation ? number(calculatedCompound.formation.enthalpy, 6) : "—"}</strong><small>kJ/mol</small></article>
                <article><p>ΔG°<sub>f,298</sub><span>Gibbs energy of formation</span></p><strong>{calculatedCompound.formation ? number(calculatedCompound.formation.gibbsEnergy, 6) : "—"}</strong><small>kJ/mol</small></article>
              </section>

...
function DataTable({
  ...
  return (
    <div className="overflow-hidden rounded-[1.5rem] border border-ink/10 bg-surface/70">
    ...
    <>
      ...
      <section className="page-section pt-10 sm:pt-12">
        <div className="flex flex-wrap gap-3">
          ...
          <a className="rounded-full border border-ink/20 px-5 py-3 text-sm font-semibold transition hover:border-ink hover:bg-surface" download href="/BEM 114 Report - Varun, Will, Curtis.pdf">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-3">
          {["/project-previews/bem-114-report/preview-1.png", "/project-previews/bem-114-report/preview-2.png", "/project-previews/bem-114-report/preview-3.png"].map((src, index) => (
            <div className="relative overflow-hidden rounded-[1.6rem] border border-ink/10 bg-surface/55" key={src}>

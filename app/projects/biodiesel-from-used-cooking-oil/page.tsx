        ...
        <div className="space-y-8">
          <article className="rounded-[2rem] border border-ink/10 bg-surface/55 p-6 sm:p-8">
            <div className="flex flex-wrap items-baseline justify-between gap-3">
              ...
              <time className="text-sm font-semibold text-ink/55" dateTime="2026-06">June 2026</time>
            </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            {sections.map((section) => (
              <article className="flex flex-col rounded-[2rem] border border-ink/10 bg-surface/55 p-6 sm:p-8" key={section.title}>
                ...
                <div className="mt-6 overflow-hidden rounded-[1.5rem] border border-ink/10 bg-paper/80 lg:mt-auto">
                  <div className="relative aspect-[4/3]">
                    <Image
                      alt={section.previewAlt}
                      className={section.id === "synthesis-presentation" ? "object-cover" : "object-contain bg-surface"}
                      fill

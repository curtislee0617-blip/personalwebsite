  ...
  return (
    <>
      ...
      <div className="page-shell pb-16 pt-5 sm:pb-20 sm:pt-6">
        <div className="lk-reference-actions"><Link href="/tools/compound-properties">← Back to calculator</Link><a download href="/documents/koretsky-lee-kesler.pdf">Download source PDF</a></div>
